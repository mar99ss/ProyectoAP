...
import {
  ...
  export default class ListaTutoriaVerbos extends Component {
    render(){
        return(
            <div class="container" style={{ zIndex: 2 }}>
                <br/>
                <h1 class="title">Verbos</h1>
                <div class="row"> 
                  ...
                  <div class= " col-3">
                    ...
                    <Card style={{borderRadius: 25,backgroundColor:getColor()}}>
                        ...
                        <br/>
                        <CardText style={textStyle} >Introduccion a los verbos</CardText>
                    </Card>
                  </div>
                  <div class="col-8 justify-content-md-center">
                    <Row className="justify-content-md-center">
                      <Card style={{borderRadius: 25}} >
                        <br/>
                        <ReactPlayer url="https://www.youtube.com/watch?v=QfdinWkTvYM" controls={true} />
                      </Card>
                    </Row>
