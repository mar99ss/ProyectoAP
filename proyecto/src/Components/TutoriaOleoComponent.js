...
import {
  ...
  export default class ListaTutoriaOleo extends Component {
    render(){
        return(
            <div class="container" style={{ zIndex: 2 }}>
                <br/>
                <h1 class="title">Pintura Oleo</h1>
                <div class="row"> 
                  ...
                  <div class= " col-3">
                    ...
                    <Card style={{borderRadius: 25,backgroundColor:getColor()}}>
                        ...
                        <br/>
                        <CardText style={textStyle} >Este es un ejemplo de como pintar en oleo</CardText>
                    </Card>
                  </div>
                  <div class="col-8 justify-content-md-center">
                    <Row className="justify-content-md-center">
                      <Card style={{borderRadius: 25}} >
                        <br/>
                        <ReactPlayer url="https://www.youtube.com/watch?v=lLWEXRAnQd0" controls={true} />
                      </Card>
                    </Row>
